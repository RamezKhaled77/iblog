...
export function BentoGridSection() {
  const time = useSyncExternalStore(subscribeClock, getClockSnapshot, getServerClock);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 sm:mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-2.5">
              Live snapshots of developer culture, ongoing reading sprints, real-time presence, and creative energy.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 auto-rows-auto">
          ...
          <div className="group relative flex flex-col justify-between p-6 sm:p-7 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md hover:shadow-primary/5 transition-all duration-300 md:row-span-2">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Weekly Sprint</span>
              ...
              <h3 className="text-xl sm:text-2xl font-bold font-heading text-foreground mt-2">Knowledge Goal</h3>
            </div>

            {/* Circular Progress */}
            <div className="relative my-6 flex items-center justify-center">
              <svg className="size-36 -rotate-90" viewBox="0 0 120 120">
                <circle cx="60" cy="60" r="48" className="stroke-muted/40 fill-none" strokeWidth="10" />
                <circle
                  cx="60" cy="60" r="48"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-black font-heading text-foreground tracking-tight">75%</span>
                <span className="text-[10px] uppercase font-semibold text-muted-foreground">In Progress</span>
              </div>
            </div>

            {/* Weekday bar chart */}
            <div className="mb-4">
              <p className="text-[10px] uppercase font-semibold text-muted-foreground mb-2">This Week</p>
                  ...
                  return (
                    <div key={i} className="flex flex-col items-center flex-1 gap-0.5">
                      <div
                        ...
                        style={{ height: `${hs[i]}%`, opacity: i < 5 ? 1 : 0.35 }}
                      />
            ...
            <div className="border-t border-border/60 pt-4">
              <div className="flex items-baseline justify-between">
                <span className="text-3xl font-black font-heading text-foreground">2.5K</span>
                <span className="text-xs font-semibold text-emerald-500">+18% this month</span>
              </div>
              <p className="text-xs text-muted-foreground mt-1">263 technical articles finished this season</p>
              <div className="flex flex-wrap gap-1.5 mt-3">
                {["React", "Systems", "DevOps"].map((tag) => (
                  <span key={tag} className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-primary/10 text-foreground border border-primary/20">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-rose-500/50 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Article Views</span>
            ...
            <div className="mt-3">
              <span className="text-3xl sm:text-4xl font-black font-heading text-foreground tracking-tight">4.8K</span>
              <p className="text-xs text-muted-foreground mt-0.5 font-medium">Unique readers · last 24 h</p>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between text-[9px] text-muted-foreground mt-1 font-medium">
                <span>10 days ago</span><span>Today</span>
              </div>
            </div>

            <div className="border-t border-border/60 pt-3 mt-3 flex items-center justify-between">
              <span className="text-[11px] text-muted-foreground font-medium">Peak: 09:00 AM</span>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-indigo-500/50 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Active Readers</span>
            ...
            <div className="mt-3">
              <span className="text-3xl sm:text-4xl font-black font-heading text-foreground tracking-tight">57K</span>
              <p className="text-xs text-muted-foreground mt-0.5 font-medium">Subscribed developers worldwide</p>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between text-[9px] text-muted-foreground mt-1 font-medium">
                <span>10 wk ago</span><span>Now</span>
              </div>
            </div>

            <div className="border-t border-border/60 pt-3 mt-3 flex items-center justify-between">
              <span className="text-[11px] text-muted-foreground font-medium">Goal: 100K</span>
              <div className="flex items-center gap-2">
                <div className="h-1.5 w-20 rounded-full bg-muted overflow-hidden">
                  <div className="h-full w-[57%] bg-indigo-500 rounded-full" />
                </div>
                <span className="text-[11px] font-bold text-indigo-500">57%</span>
              </div>
            </div>
          </div>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Collaborative Authors</span>
            ...
            <div className="my-4 flex items-center -space-x-2.5 overflow-hidden">
              <div className="relative size-9 rounded-full border-2 border-background overflow-hidden ring-1 ring-border">
                <Image src="/icon.jpeg" alt="Ramez" width={36} height={36} className="object-cover size-full" />
              ...
              {(
                ...
                <div key={initials} className={`relative size-9 rounded-full border-2 border-background ring-1 ring-border bg-gradient-to-tr ${grad} flex items-center justify-center text-white text-xs font-bold`}>
                  {initials}
                  {online && <span className="absolute bottom-0 right-0 size-2 rounded-full bg-emerald-500 ring-1 ring-background" />}
                </div>
              ))}
            ...
            <div className="border-t border-border/60 pt-3 flex items-center justify-between">
              <div>
                <span className="text-xs uppercase text-muted-foreground font-semibold">Daily New Authors</span>
                <p className="text-xl font-black font-heading text-foreground">
                  54 <span className="text-xs font-bold text-emerald-500">+40%</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border/80 bg-gradient-to-br from-card via-card/90 to-primary/10 dark:from-card dark:via-card/70 dark:to-primary/5 p-6 sm:p-8 md:col-span-2 shadow-md hover:border-primary/60 transition-all duration-300 flex flex-col justify-between min-h-[360px]">
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-foreground">Interactive Creator Hub</span>
              </div>
              <span className="text-xs font-medium text-muted-foreground">Studio View 3.0</span>
            </div>
              ...
              <div className="relative w-full h-64 sm:h-72 rounded-2xl overflow-hidden border border-border/60 shadow-inner group-hover:scale-[1.01] transition-transform duration-500">
                ...
                <div className="absolute top-3 left-3 bg-background/90 dark:bg-card/90 backdrop-blur-md border border-border/80 rounded-xl px-3 py-1.5 shadow-lg pointer-events-none">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[11px] font-bold text-foreground">26,807</span>
                  </div>
                  <p className="text-[9px] text-muted-foreground font-semibold">Active Interactions</p>
                </div>
                <div className="absolute bottom-3 right-3 bg-background/90 dark:bg-card/90 backdrop-blur-md border border-border/80 rounded-xl px-3 py-1.5 shadow-lg pointer-events-none">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[11px] font-bold text-foreground">19.46%</span>
                  </div>
                  <p className="text-[9px] text-emerald-500 font-semibold">▲ +102.48% Engagement</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 flex items-center justify-between border-t border-border/60 pt-3">
              ...
              <Link href="/blog" className="inline-flex items-center gap-1 text-xs font-bold text-foreground hover:text-primary transition-colors">
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Developer Creed</span>
              ...
              <p className="text-xs text-muted-foreground mt-3 leading-relaxed">
                Empowering software builders to turn thoughts into production systems.
              </p>
              {/* Value pillars */}
              <div className="mt-4 grid grid-cols-3 gap-2">
                {[
                  { icon: <Target className="size-3.5 text-primary" />, label: "Focus" },
                  { icon: <Zap className="size-3.5 text-amber-500" />, label: "Speed" },
                  { icon: <BookOpen className="size-3.5 text-blue-500" />, label: "Learn" },
                  { icon: <ArrowUp className="size-3.5 text-emerald-500" />, label: "Grow" },
                  { icon: <Users className="size-3.5 text-fuchsia-500" />, label: "Share" },
                  { icon: <Network className="size-3.5 text-red-500" />, label: "Connect" },
                ].map(({ icon, label }) => (
                  <div key={label} className="flex flex-col items-center gap-1 py-2 rounded-xl bg-muted/60 border border-border/40">
                    {icon}
            ...
            <div className="mt-4 flex items-center gap-3 border-t border-border/60 pt-4">
              <div className="relative size-11 rounded-full overflow-hidden border-2 border-primary">
                <Image src="/icon.jpeg" alt="Ramez Khaled" width={44} height={44} className="object-cover size-full" />
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground font-medium">Architect &amp; Lead Writer</p>
              </div>
            </div>
          </div>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Live Studio Time</span>
            ...
            <div className="my-5">
              <div className="flex items-center gap-2 text-muted-foreground mb-2">
                ...
                <span className="text-xs font-mono font-medium">LOCAL TIME</span>
              </div>
            ...
            <div className="border-t border-border/60 pt-3 flex items-center justify-between text-xs text-muted-foreground">
              ...
              <span className="font-semibold text-foreground">Friday 9:00 AM</span>
            </div>
          </div>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Design Identity</span>
              <h4 className="text-xl font-bold font-heading text-foreground mt-1">Typography &amp; Style</h4>
              <p className="text-xs text-muted-foreground font-mono mt-0.5">Space Grotesk + Inter</p>
            </div>
            <div className="my-5 flex items-center gap-2">
              {[
                { bg: "bg-neutral-900", title: "Deep Charcoal" },
                { bg: "bg-slate-500", title: "Slate" },
                { bg: "bg-primary ring-2 ring-primary/20 border-primary/50", title: "Electric Lime" },
                { bg: "bg-neutral-100 dark:bg-neutral-800", title: "Surface" },
              ].map(({ bg, title }) => (
                <div key={title} className={`size-8 rounded-xl border border-border shadow-xs ${bg}`} title={title} />
              ))}
            </div>
          ...
          <div className="group relative overflow-hidden p-6 sm:p-8 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md md:col-span-2 shadow-sm hover:border-primary/60 transition-all duration-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="max-w-md">
              <span className="text-xs font-bold uppercase tracking-wider text-primary">The Mission</span>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mt-2 leading-relaxed">
                Crafting meaningful engineering architecture, software systems, and real-world implementation guides.
              </p>
            </div>
          ...
          <div className="group relative overflow-hidden p-6  rounded-3xl md:col-span-2 border border-primary/30 bg-gradient-to-br from-primary/15 via-primary/5 to-card dark:from-primary/10 dark:via-card dark:to-card backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md hover:shadow-primary/10 transition-all duration-300 flex flex-col justify-between">
            ...
            <div className="pointer-events-none absolute -top-6 -right-6 size-24 rounded-full bg-primary/20 blur-2xl" aria-hidden="true" />

            <div>
              <span className="text-lg font-bold uppercase tracking-wider text-primary">Community</span>
              <h4 className="text-2xl sm:text-3xl font-extrabold font-heading text-foreground tracking-tight mt-1 leading-tight">
                Write with us. And Discover ideas<br />Grow together.
              </h4>
              <p className="text-[11px] text-muted-foreground mt-2 leading-relaxed">
                Join 57K+ developers publishing their best engineering work on iBlog.
              </p>
            </div>
          ...
          <div className="group p-6 rounded-3xl border border-border/80 bg-card/90 dark:bg-card/60 backdrop-blur-md shadow-sm hover:border-primary/60 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Top Topics</span>
            ...
            <div className="flex flex-col gap-2.5 flex-1">
              {[
                ...
                <div key={label} className="flex items-center gap-3">
                  <span className="text-[11px] font-bold text-muted-foreground w-20 shrink-0">{label}</span>
